...
- Bump the ktsu group with 2 updates ([@dependabot[bot]](https://github.com/dependabot[bot]))
- Bump TestableIO.System.IO.Abstractions.TestingHelpers from 22.1.1 to 22.2.0 ([@dependabot[bot]](https://github.com/dependabot[bot]))
- Bump Testably.Abstractions.FileSystem.Interface from 10.2.0 to 10.3.0 ([@dependabot[bot]](https://github.com/dependabot[bot]))
- Bump TestableIO.System.IO.Abstractions.Wrappers and Testably.Abstractions.FileSystem.Interface ([@dependabot[bot]](https://github.com/dependabot[bot]))
- Bump TestableIO.System.IO.Abstractions and Testably.Abstractions.FileSystem.Interface ([@dependabot[bot]](https://github.com/dependabot[bot]))
- Bump the ktsu group with 1 update ([@dependabot[bot]](https://github.com/dependabot[bot]))
- Bump the ktsu group with 1 update ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
Changes since v1.16.31:

- Bump the ktsu group with 3 updates ([@dependabot[bot]](https://github.com/dependabot[bot]))

## v1.16.31 (patch)

Changes since v1.16.30:

- Bump the ktsu group with 3 updates ([@dependabot[bot]](https://github.com/dependabot[bot]))

## v1.16.30 (patch)

Changes since v1.16.29:

- Bump the ktsu group with 4 updates ([@dependabot[bot]](https://github.com/dependabot[bot]))

## v1.16.29 (patch)

Changes since v1.16.28:

- Bump the ktsu group with 4 updates ([@dependabot[bot]](https://github.com/dependabot[bot]))

## v1.16.28 (patch)

Changes since v1.16.27:

- Bump the ktsu group with 12 updates ([@dependabot[bot]](https://github.com/dependabot[bot]))

## v1.16.27 (patch)

Changes since v1.16.26:
...
Changes since v1.16.25:

- Bump Testably.Abstractions.FileSystem.Interface from 10.1.0 to 10.2.0 ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
## v1.15.14-pre.7 (prerelease)

Changes since v1.15.14-pre.6:
...
## v1.15.14-pre.4 (prerelease)

Changes since v1.15.14-pre.3:

- Merge remote-tracking branch 'refs/remotes/origin/main' ([@ktsu[bot]](https://github.com/ktsu[bot]))
- Sync global.json ([@ktsu[bot]](https://github.com/ktsu[bot]))
- Sync COPYRIGHT.md ([@ktsu[bot]](https://github.com/ktsu[bot]))

## v1.15.14-pre.3 (prerelease)

Changes since v1.15.14-pre.2:

- Merge remote-tracking branch 'refs/remotes/origin/main' ([@ktsu[bot]](https://github.com/ktsu[bot]))
- Sync scripts\PSBuild.psm1 ([@ktsu[bot]](https://github.com/ktsu[bot]))

## v1.15.14-pre.2 (prerelease)

Changes since v1.15.14-pre.1:
...
## v1.15.13-pre.9 (prerelease)

Changes since v1.15.13-pre.8:
...
## v1.15.13-pre.7 (prerelease)

Changes since v1.15.13-pre.6:

- Bump Polyfill from 9.7.5 to 9.7.6 ([@dependabot[bot]](https://github.com/dependabot[bot]))

## v1.15.13-pre.6 (prerelease)

Changes since v1.15.13-pre.5:

- Merge remote-tracking branch 'refs/remotes/origin/main' ([@ktsu[bot]](https://github.com/ktsu[bot]))
- Sync scripts\update-winget-manifests.ps1 ([@ktsu[bot]](https://github.com/ktsu[bot]))

## v1.15.13-pre.5 (prerelease)

Changes since v1.15.13-pre.4:
...
## v1.15.13-pre.2 (prerelease)

Changes since v1.15.13-pre.1:
...
## v1.15.11-pre.4 (prerelease)

Changes since v1.15.11-pre.3:

- Remove redundant testing package references ([@matt-edmondson](https://github.com/matt-edmondson))

## v1.15.11-pre.3 (prerelease)

Changes since v1.15.11-pre.2:

- Sync scripts\update-winget-manifests.ps1 ([@ktsu[bot]](https://github.com/ktsu[bot]))

## v1.15.11-pre.2 (prerelease)

Changes since v1.15.11-pre.1:
...
Changes since v1.15.9:

- Update configuration files and enhance build process ([@matt-edmondson](https://github.com/matt-edmondson))

## v1.15.9 (patch)

Changes since v1.15.8:
...
No significant changes detected since v1.15.3-pre.13.

## v1.15.3-pre.13 (prerelease)

No significant changes detected since v1.15.3-pre.12.

## v1.15.3-pre.12 (prerelease)

No significant changes detected since v1.15.3-pre.11.

## v1.15.3-pre.11 (prerelease)

No significant changes detected since v1.15.3-pre.10.

## v1.15.3-pre.10 (prerelease)

No significant changes detected since v1.15.3-pre.9.

## v1.15.3-pre.9 (prerelease)

No significant changes detected since v1.15.3-pre.8.

## v1.15.3-pre.8 (prerelease)

No significant changes detected since v1.15.3-pre.7.

## v1.15.3-pre.7 (prerelease)

No significant changes detected since v1.15.3-pre.6.

## v1.15.3-pre.6 (prerelease)

No significant changes detected since v1.15.3-pre.5.

## v1.15.3-pre.5 (prerelease)

No significant changes detected since v1.15.3-pre.4.

## v1.15.3-pre.4 (prerelease)

No significant changes detected since v1.15.3-pre.3.
...
No significant changes detected since v1.15.3-pre.1.
...
No significant changes detected since v1.15.2-pre.4.

## v1.15.2-pre.4 (prerelease)

No significant changes detected since v1.15.2-pre.3.

## v1.15.2-pre.3 (prerelease)

No significant changes detected since v1.15.2-pre.2.

## v1.15.2-pre.2 (prerelease)

No significant changes detected since v1.15.2-pre.1.
...
No significant changes detected since v1.4.7-pre.23.
...
No significant changes detected since v1.4.7-pre.17.

## v1.4.7-pre.17 (prerelease)

No significant changes detected since v1.4.7-pre.16.
...
No significant changes detected since v1.4.7-pre.13.

## v1.4.7-pre.13 (prerelease)

No significant changes detected since v1.4.7-pre.12.
...
No significant changes detected since v1.4.7-pre.10.

## v1.4.7-pre.10 (prerelease)

No significant changes detected since v1.4.7-pre.9.
...
No significant changes detected since v1.4.7-pre.6.
...
No significant changes detected since v1.4.7-pre.4.
...
No significant changes detected since v1.3.16-pre.2.
...
- Updated packages in AppDataStorage.csproj ([@matt-edmondson](https://github.com/matt-edmondson))
